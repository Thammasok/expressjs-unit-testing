const { assert, spy, stub, mock, createSandbox } = require("sinon")

const database = require("../controllers/db")
const store = require("../controllers/db/store")(database)

// Sample user data
const harry = { id: 0, name: "Harry" }
const john = { id: 1, name: "John" }

describe('Test mocking Demo', () => {
  /**
   * Stubs:
   *
